  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm mb-12">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4 sm:gap-0">
        ...
        <span className="text-lg font-bold text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/30 px-4 py-2 rounded-lg self-end sm:self-auto">
          {accuracy}% de Acerto
        </span>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-100 dark:border-gray-600">
          <div className="text-gray-500 dark:text-gray-400 text-sm font-semibold mb-1">
            Total Resolvidas
          </div>
        ...
        <div className="p-4 bg-[#FFE5E5] dark:bg-red-900/20 rounded-lg border border-[#FF9999] dark:border-red-800">
          ...
          <div className="text-3xl font-bold text-[#CC0000] dark:text-red-500">
            {stats.wrong}
          </div>
        </div>
      </div>
