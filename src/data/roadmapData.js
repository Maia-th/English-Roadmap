...
export const tracksData = {
  english: {
    ...
    shortName: 'English',
    flag: '🇺🇸',
    dashboardTitle: '🚀 Bem-vindo ao seu Dashboard',
    dashboardSubtitle: 'Acompanhe seu progresso diário rumo ao C1 em 12 meses',
  ...
  spanish: {
    ...
    dailyTasks: [
      { id: 0, title: '🎧 Listening / Input', duration: '1h15', completed: false },
      { id: 1, title: '🗣️ Speaking', duration: '45m', completed: false },
      { id: 2, title: '📚 Vocabulary (Anki)', duration: '30m', completed: false },
      { id: 3, title: '✍️ Grammar / Writing', duration: '30m', completed: false },
    ],
    phases: [
      {
